...
const GrammarChecker = () => {
  ...
  useEffect(() => {
    document.title = 'Grammar Checker Tool';
  }, []);
  ...
  const handleCheck = () => {
    ...
    // Mock grammar check function. Replace with actual API call in real-world scenario.
    const checked = inputText.split(' ').map((word) => `${word}_checked`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Grammar Checker Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to check grammar"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleCheck} className="primary_button text-2xl hover:bg-gray-900">
                  Check Grammar
                </button>
              </div>
            </form>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to be checked."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Check Grammar"
              text="Click the 'Check Grammar' button to check the text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
