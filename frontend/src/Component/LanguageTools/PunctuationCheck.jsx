...
const PunctuationChecker = () => {
  ...
  useEffect(() => {
    document.title = 'Punctuation Checker Tool';
  }, []);
  ...
  const handleCheckPunctuation = () => {
    ...
    // Mock punctuation checking function. Replace with actual API call in real-world scenario.
    const checked = inputText.split(' ').map((word) => `${word}_punc`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Punctuation Checker Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to check punctuation"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleCheckPunctuation} className="primary_button text-2xl hover:bg-gray-900">
                  Check Punctuation
                </button>
              </div>
            </form>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to check punctuation."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Click the 'Check Punctuation' button to generate the checked text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
