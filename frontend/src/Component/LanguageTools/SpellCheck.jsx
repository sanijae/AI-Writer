...
const SpellChecker = () => {
  ...
  useEffect(() => {
    document.title = 'Spell Checker Tool';
  }, []);
  ...
  const handleCheckSpelling = () => {
    ...
    // Mock spell checking function. Replace with actual API call in real-world scenario.
    const checked = inputText.split(' ').map((word) => `${word}_spell`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Spell Checker Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to check spelling"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleCheckSpelling} className="primary_button text-2xl hover:bg-gray-900">
                  Check Spelling
                </button>
              </div>
            </form>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to check spelling."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Check Spelling"
              text="Click the 'Check Spelling' button to generate the checked text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
