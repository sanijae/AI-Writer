...
const Translator = () => {
  ...
  useEffect(()=>{
    document.title='Translator tool'
  },[])
  ...
  const handleTranslate = () => {
    ...
    // Mock translate function. Replace with actual API call in real-world scenario.
    const translated = inputText.split(' ').map((word) => `${word}_trans`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Translator Tool</div>
      </div>
          ...
          <div className="w-full md:mr-1 p-2 bg-white">
            <form>
              ...
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleTranslate} className="primary_button text-2xl hover:bg-gray-900">
                  Translate
                </button>
              </div>
            </form>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to translate."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Click the 'Translate' button to generate the translated text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
