...
const SentenceRewriter = () => {
  ...
  useEffect(()=>{
    document.title='Sentence re-writer tool'
  },[])
  ...
  const handleRewrite = () => {
    ...
    // Mock rewrite function. Replace with actual API call in real-world scenario.
    const rewritten = inputText.split(' ').map((word) => `${word}_rew`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Sentence Rewriter Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to rewrite"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleRewrite} className="primary_button text-2xl hover:bg-gray-900">
                  Rewrite
                </button>
              </div>
            </form>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to be rewritten."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Rewrite"
              text="Click the 'Rewrite' button to generate the rewritten text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
