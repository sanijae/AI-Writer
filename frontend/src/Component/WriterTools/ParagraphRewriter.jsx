...
const ParagraphRewriter = () => {
  ...
  useEffect(()=>{
    document.title='Paragraph re-writer tool'
  },[])
  ...
  const handleParaphrase = () => {
    ...
    // Mock paraphrasing function. Replace with actual API call in real-world scenario.
    const ReWrite = inputText.split(' ').map((word) => `${word}_par`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Re-writer Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to re-write"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleParaphrase} className="primary_button text-2xl hover:bg-gray-900">
                Rewrite
                </button>
              </div>
            </form>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  value={ReWriteText}
                  readOnly
                  placeholder="Re-writed text will appear here"
                />
              </div>
            </form>
          </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to be Re-write."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Paraphrase"
              text="Click the 'Re-Write' button to generate the Re-write text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
