...
const AIWriterFlow = () => {
  ...
  const handleGenerate = () => {
    ...
    // Mock generate function. Replace with actual API call in real-world scenario.
    const output = inputText.split(' ').map((word) => `${word}_gen`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">AI Writer Flow Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to generate AI content"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleGenerate} className="primary_button text-2xl hover:bg-gray-900">
                  Generate
                </button>
              </div>
            </form>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to generate AI content."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Click the 'Generate' button to generate AI content."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
