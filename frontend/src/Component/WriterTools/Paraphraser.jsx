...
const Paraphraser = () => {
  ...
  useEffect(()=>{
    document.title='Paraphraser tool'
  },[])
  ...
  const handleParaphrase = () => {
    ...
    const paraphrased = inputText.split(' ').map((word) => `${word}_par`).join(' ');
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">Paraphraser Tool</div>
      </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to be paraphrased."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Click the 'Paraphrase' button to generate the paraphrased text."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
