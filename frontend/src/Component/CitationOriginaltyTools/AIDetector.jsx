...
const AIDetector = () => {
  ...
  useEffect(() => {
    document.title = 'AI Detector Tool';
  }, []);
  ...
  const handleDetectAI = () => {
    ...
    // Mock AI detection function. Replace with actual API call in real-world scenario.
    const result = `${inputText}_AI_detection_result`;
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">AI Detector Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to detect AI-generated content"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleDetectAI} className="primary_button text-2xl hover:bg-gray-900">
                  Detect AI Content
                </button>
              </div>
            </form>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  readOnly
                  placeholder="AI detection result will appear here"
                />
              </div>
            </form>
          </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to detect AI content."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Detect AI Content"
              text="Click the 'Detect AI Content' button to get the result."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
