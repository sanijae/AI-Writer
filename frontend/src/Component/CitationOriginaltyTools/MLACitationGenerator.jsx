...
const MLACitationGenerator = () => {
  ...
  useEffect(() => {
    document.title = 'MLA Citation Generator Tool';
  }, []);
  ...
  const handleGenerateMLACitation = () => {
    if (!inputText.trim()) {
      setError('Input text cannot be empty');
      return;
    }

    // Mock MLA citation generation function. Replace with actual API call in real-world scenario.
    const citation = `${inputText}_MLA_citation`;
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="text-2xl primary_color">MLA Citation Generator Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to generate MLA citation"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleGenerateMLACitation} className="primary_button text-2xl hover:bg-gray-900">
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  readOnly
                  placeholder="Generated MLA citation will appear here"
                />
              </div>
            </form>
          </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to generate MLA citation."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Generate MLA Citation"
              text="Click the 'Generate MLA Citation' button to get the citation."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
...
export default MLACitationGenerator;
