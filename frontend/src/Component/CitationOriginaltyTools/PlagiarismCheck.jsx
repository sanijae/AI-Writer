...
const PlagiarismChecker = () => {
  ...
  useEffect(() => {
    document.title = 'Plagiarism Checker Tool';
  }, []);
  ...
  const handleCheckPlagiarism = () => {
    ...
    // Mock plagiarism check function. Replace with actual API call in real-world scenario.
    const result = `${inputText}_plagiarism_check`;
  ...
  return (
    <div className="p-3">
      <div className="bg-white p-3 mb-2 flex flex-col-reverse md:flex-row justify-between items-center">
        <SelectOptions handleLanguageChange={handleLanguageChange} />
        <div className="text-2xl primary_color">Plagiarism Checker Tool</div>
      </div>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  placeholder="Enter or paste text here to check for plagiarism"
                ></textarea>
              </div>
              <div className="flex justify-between items-center align-middle">
                ...
                <button onClick={handleCheckPlagiarism} className="primary_button text-2xl hover:bg-gray-900">
                  Check Plagiarism
                </button>
              </div>
            </form>
            ...
            <form>
              <div className="mb-2 flex flex-col p-2">
                <textarea
                  ...
                  readOnly
                  placeholder="Plagiarism check result will appear here"
                />
              </div>
            </form>
          </div>
        ...
        <div className="row justify-content-center">
          ...
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              ...
              text="Alternatively, upload a text file to check for plagiarism."
              icon={<MdFileUpload />}
            />
          </div>
          <div className="col-lg-4 shadow-md">
            <HowItWorksCard
              title="Step 3: Check Plagiarism"
              text="Click the 'Check Plagiarism' button to get the result."
              icon={<MdFileUpload />}
            />
          </div>
        </div>
